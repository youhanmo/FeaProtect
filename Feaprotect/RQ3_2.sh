...
do
    ...
    nohup python -u RQ3_2.py --fix_type $fix_type --ensemble $ensemble --dataset $dataset --model $dataset --num_classes $num_classes --dataset_col $dataset_col > $save_path 2>&1 &
done